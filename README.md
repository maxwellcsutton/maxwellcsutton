...
By day I build the QA department's AI tooling: a test-triage agent on Claude Opus (Bedrock) that
...
The thread through all of it: agents are only useful if you can verify what they did and bound
what they can do. Judges should be blind, reviewers should be a different model family than the
author, and autonomous runs get hard budgets — not vibes.
